...
Provides simple interface to the complex classes system, library or framework.

Real life:
Boot car with the key buy 1 button - i don't know how it works but i know how to make it(result).

Programming:
Reduce usage of some complex library that we don't need.


Consequences: Facade class (the only one class) can become magic (Божественный) we have to apply SOLID principles
